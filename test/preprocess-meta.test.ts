...
describe('Extracts known properties', () => {
	test('Sections in curly braces', async () => {
		await expectMetaResult('output={2-5}', {
			meta: '',
		})

		await expectMetaResult('output={2-5,6-10}', {
			meta: '',
		})
		...
		await expectMetaResult('hello output={2-5} world', {
			meta: 'hello world',
		})
	})

	test('Invalid sections in curly braces', async () => {
		await expectMetaResult('output={5-2}', {
			meta: '',
		})

		await expectMetaResult('output={2-}', {
			meta: '',
		})

		await expectMetaResult('output={2-5,3-6}', {
			meta: '',
		})

		await expectMetaResult('output={2-5,5-6}', {
			meta: '',
		})

		await expectMetaResult('output={2-5,1-2}', {
			meta: '',
		})

		await expectMetaResult('output={none}', {
			meta: '',
		})

		await expectMetaResult('hello output={world} world', {
			meta: 'hello world',
		})

		await expectMetaResult('output={}', {
			meta: '',
		})
	})
})
